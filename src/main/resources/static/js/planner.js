...
let gotoChatBtn = document.getElementById("gotoChat");
gotoChatBtn.addEventListener("click", link);

function link(){
    console.log(planner.plannerNO);
    let mnoText = member.memberNo;
    let pnoText = planner.plannerNo;
